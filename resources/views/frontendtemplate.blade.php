...
-->
     ...
     <!-- MAIN CSS -->
     <link rel="stylesheet" href="{{ asset('frontendtemplate/css/templatemo-style.css')}}">
...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
     ...
     <script src="{{ asset('frontendtemplate/js/smoothscroll.js')}}"></script>
     <script src="{{ asset('frontendtemplate/js/custom.js')}}"></script>
